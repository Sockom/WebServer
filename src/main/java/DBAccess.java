...
// Start of establishing connection
        ...
        public Connection getConnection() {
            String dbURL = "jdbc:sqlserver://growbro.cdkppreaz70m.us-east-2.rds.amazonaws.com;databaseName=GrowBroDWH;user=admin;password=adminadmin;allowMultiQueries=true";//K:SMPCJNQ Mk:P2FRPBU KH:ASU6SHH MB:HFHHMQP
